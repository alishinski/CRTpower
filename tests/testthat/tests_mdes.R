...
expect_equal(round(BCRA4_2r(R2_1 = 0.50, R2_2 = 0.50, R2_3T = 0.50, R2_4T = 0.50, P = 0.50, g_4 = 1, n = 10, J = 4, K = 4, L = 20, rho_4 = 0.05, rho_3 = 0.15, rho_2 = 0.15, omega_4 = 0.50, omega_3 = 0.50, tails = 2), digits = 3), 0.146)

# 4-Level Fixed Effects Blocked Cluster Random Assignment Designs (BCRA4_3f)—Treatment at Level 3
expect_equal(round(BCRA4_3f(R2_1 = 0.50, R2_2 = 0.50, R2_3 = 0.50, P = 0.50, g_3 = 2, n = 10, J = 4, K = 4, L = 15, rho_2 = 0.15, rho_3 = 0.15, tails = 2) , digits = 3), 0.240)
